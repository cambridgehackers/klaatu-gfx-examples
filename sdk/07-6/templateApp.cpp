...
vec3 eye, up = { 0.0f, 0.0f, 1.0f };
OBJMESH *player = NULL;
vec3 next_eye;
float rotx = -165.0f, next_rotx = rotx, rotz = 180.0f, next_rotz = rotz, distance = -5.0f;
...
void templateAppDraw(void)
{
	...
	player->btrigidbody->setAngularVelocity(btVector3(direction.y * (move_delta.z * 6.7f), -direction.x * (move_delta.z * 6.7f), 0.0f));
