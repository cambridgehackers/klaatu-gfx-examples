...
vec3 move_location, move_delta;
vec3 eye, center, up = { 0.0f, 0.0f, 1.0f };
OBJMESH *player = NULL;
...
void templateAppDraw(void)
{
    ...
    GFX_load_identity();
    if (move_delta.z) {
	player->btrigidbody->setAngularVelocity(btVector3(-move_delta.x * move_delta.z * 6.7f, move_delta.y * move_delta.z * 6.7f, 0.0f));
